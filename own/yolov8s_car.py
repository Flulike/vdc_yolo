...
class_name = ('car', 'light-cargo', 'bus', 'cargo', 'special', 'motorcycle', 'bicycle', 'person', )
...
data_root = './data/dataset/carclasscoco/'
...
val_ann_file = 'valid/annotations/valid.json'
...
weight_decay = 0.0005
widen_factor = 0.5
work_dir = './work_dir/carclassovo_1'